## Experiment 3  
**Question:**  
Update the same page using external style sheets (move the added styles to a CSS file) and add it to the HTML page.

**Solution:**  
This solution separates the styling from the HTML. The HTML file links to an external CSS file (mystyle.css).
...
<body>
    ...
    <div>
        <div class="proj">
            ...
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Illum rerum omnis earum enim amet ducimus...
        </div>
        <div class="proj">
...
.profile {
    box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.735);
    max-width: 15%;
    display: block;
    margin-left: auto;
    margin-right: auto;
...
*Expected Output:*  
The same portfolio page appears as before but now the styles are maintained separately in the external CSS file.
